...
\item \textbf{Carlson cipher counting} --- Lemma~4.1 \emph{done}
  (2026-07-19): \texttt{card\_consistent\_keys} in
  \texttt{Ste/Carlson/Counting.lean}. Theorem~4.1 (the $P$-cipher key
  count) remains open.
\item \textbf{Cipher reduction} (Theorem~5.1/5.2, Corollary~5.3): every
  block cipher is a block substitution cipher --- \emph{done}
  (2026-07-19) in \texttt{Ste/Carlson/Reduction.lean}.
