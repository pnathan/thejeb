...
set is \texttt{Ste.Convex}. The graded/fuzzy case is now closed by
\texttt{Ste.FuzzyFrame} (\texttt{consistencyDegree},
\texttt{cut\_fuzzyFeasibility}, \texttt{weightedFrame\_gradedHelly\_two});
the projection \emph{algorithms} (as opposed to the geometry) remain
open.
