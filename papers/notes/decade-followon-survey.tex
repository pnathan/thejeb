...
\section{The topological-STE program (2014--2026)}
The dissertation grew into a sustained line of follow-on papers with a
...
\item \citet{carlson2014breaking} --- journal version of the
  dissertation's known-ciphertext attack.
...
\item \citet{carlson2026entropy} --- a technical report that restates STE
  (citing Combettes 1993 and Witsenhausen--Schweppe 1968), ties STE
  explicitly to the AEP and unicity, and frames STE as ``a precursor to
  the neural network''; it dates the \emph{topological}-space STE idea to
  \textbf{2006}, predating the dissertation.
\end{itemize}
